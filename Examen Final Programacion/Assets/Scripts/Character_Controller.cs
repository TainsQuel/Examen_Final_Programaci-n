...
public class Character_Controller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Llama al Animator del object al que está asignado el script
    ...
    void Update()
    {
        ...
        // Modifica el valor de las variables del animator para que reproduzcan la animacion ya previamente seteada
        CharacterAnimator.SetFloat("VelocidadX", CharacterInput.x);
        CharacterAnimator.SetFloat("VelocidadZ", CharacterInput.z);
        CharacterAnimator.SetFloat("MagnitudVelocidad", CharacterInput.magnitude);
